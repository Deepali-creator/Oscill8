...
/**
 * Controller that renders the AboutPage page.
 *
 * @module controllers/AboutPage
 */
...
function show() {
    ...
    app.getView({aboutHover:true}).render('content/aboutproduct');
}
 ...
 */
/** Renders the AboutPage page.
 * @see module:controllers/AboutPage~show */
exports.Show = guard.ensure(['get'], show);
/** Remote include for the header.
 * @see module:controllers/AboutPage~includeHeader */
exports.IncludeHeader = guard.ensure(['include'], includeHeader);
/** Renders the category navigation and the menu to use as a remote include.
 * @see module:controllers/AboutPage~includeHeaderMenu */
 ...
 * @see module:controllers/AboutPage~includeHeaderCustomerInfo */
