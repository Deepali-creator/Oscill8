...
var RateLimiter = require('app_oscill8/cartridge/scripts/util/RateLimiter');
...
function show() {
    ...
    //Custom added for password reset on login page
...
function handleLoginForm () {
    ...
    loginForm.handleAction({
        login: function () {
            ...
            //     dw.system.Logger.warn('Here RateLimit Check...');
            ...
            if (!success) {
                dw.system.Logger.warn('Here UnSuccess...');
                if (RateLimiter.isOverThreshold('FailedLoginCounter')) {
                    dw.system.Logger.warn('Here RateLimit Check...');
                    loginForm.get('customerLocked').invalidate();
                ...
                dw.system.Logger.warn('Here Success...');
                loginForm.clear();
            }
...
function processLoginForm () {
    ...
    dw.system.Logger.warn('Here Login Check....');
    dw.system.Logger.warn(request.httpParameterMap.OAuthProvider.stringValue);

    if (request.httpParameterMap.OAuthProvider.stringValue) {
        dw.system.Logger.warn('If....');
        handleOAuthLoginForm();
    } else {
        dw.system.Logger.warn('Else....');
        handleLoginForm();
    }
}
