...
/**
 * Controller that renders the Shop page.
 *
...
function show() {
    ...
    app.getView({shopHover:true}).render('content/shop');
}
 ...
 */
/** Renders the Shop page.
 * @see module:controllers/Shop~show */
exports.Show = guard.ensure(['get'], show);
/** Remote include for the header.
 * @see module:controllers/Shop~includeHeader */
exports.IncludeHeader = guard.ensure(['include'], includeHeader);
/** Renders the category navigation and the menu to use as a remote include.
 * @see module:controllers/Shop~includeHeaderMenu */
 ...
 * @see module:controllers/Shop~includeHeaderCustomerInfo */
