...
/**
 * Controller that renders the Subs page.
 *
 * @module controllers/Subs
 */
...
function show() {
    ...
    app.getView().render('account/subscriptions/subscriptionList');
}
 ...
 */
/** Renders the Subs page.
 * @see module:controllers/Subs~show */
exports.Show = guard.ensure(['get'], show);
/** Remote include for the header.
 * @see module:controllers/Subs~includeHeader */
exports.IncludeHeader = guard.ensure(['include'], includeHeader);
/** Renders the category navigation and the menu to use as a remote include.
 * @see module:controllers/Subs~includeHeaderMenu */
 ...
 * @see module:controllers/Subs~includeHeaderCustomerInfo */
