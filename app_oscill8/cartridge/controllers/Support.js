...
/**
 * Controller that renders the Support page.
 *
 * @module controllers/Support
 */
...
function show() {
    ...
    app.getView({supportHover:true}).render('content/support');
}
 ...
 */
/** Renders the Support page.
 * @see module:controllers/Support~show */
exports.Show = guard.ensure(['get'], show);
/** Remote include for the header.
 * @see module:controllers/Support~includeHeader */
exports.IncludeHeader = guard.ensure(['include'], includeHeader);
/** Renders the category navigation and the menu to use as a remote include.
 * @see module:controllers/Support~includeHeaderMenu */
 ...
 * @see module:controllers/Support~includeHeaderCustomerInfo */
