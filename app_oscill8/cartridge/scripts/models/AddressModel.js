...
AddressModel.create = function (addressForm) {
    ...
    return Transaction.wrap(function () {
        ...
        if (addressForm) {
            ...
            if ('shippingEmail' in addressForm) {
                dw.system.Logger.warn("shippingEmail");
                dw.system.Logger.warn("shippingEmailform:"+ JSON.stringify(Form.get(addressForm.shippingEmail)));
                dw.system.Logger.warn("shippingEmail:"+addressForm.shippingEmail.value);
                try{
                    if(!empty(addressForm.shippingEmail.value))
                    {
                        var shippingEmail = addressForm.shippingEmail.value;
                        dw.system.Logger.warn("shippingEmail value:"+ shippingEmail);
                        address.custom.email = shippingEmail;
                        dw.system.Logger.warn("Customemail value:"+ address.custom.email.value);
                    }
                    
                }
                catch(e){
                    dw.system.Logger.warn("shippingEmail not present");
                }
