...
var CartModel = AbstractModel.extend({
    ...
    calculate: function () {
        ...
        require('int_avatax/cartridge/scripts/app').getController('Avatax').CalculateTaxes(this.object);
        }
    ...
    addProductToCart: function() {
            ...
            if (lineItem) {
                ...
                Transaction.wrap(function () {
                    if (params.subproSubscriptionInterval.value && params.subproSubscriptionOptionMode.value) {
                        cart.updateLineItem(lineItem, productToAdd, quantity, productOptionModel, cart.getSubproParams(params));
                    } else {
        ...
        // Adds a product.
            ...
            if (productToAdd.object.isProductSet()) {
                ...
                if (params.subproSubscriptionInterval.value && params.subproSubscriptionOptionMode.value) {
                    cart.addProductItem(productToAdd.object, params.Quantity.doubleValue, productOptionModel, cart.getSubproParams(params));
                } else {
     ...
     * @param {object} {subproParams} - Object contaning options for SubPro subscription
     */
    ...
    validateForCheckout: function () {
        var ValidateCartForCheckout = require('app_oscill8/cartridge/scripts/cart/ValidateCartForCheckout');
    ...
    validatePaymentInstruments: function (customer, countryCode, amount) {
        ...
        dw.system.Logger.warn("$$$$$$$$$$$$$$$$$$$$"+JSON.stringify(paymentHelpers.validatePaymentInstruments(this, countryCode, amount)));
        dw.system.Logger.warn("&&&&&&&&&&&"+JSON.stringify(this));
...
CartModel.get = function (parameter) {
    ...
    if (!parameter) {
        ...
        dw.system.Logger.warn("currentBasket-----------------"+currentBasket);
